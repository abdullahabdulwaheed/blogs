...
const PostDetails = () => {
    ...
    return (
        <Layout>
            <Helmet>
                <title>{post.title} | MKR-BLOGS</title>
            </Helmet>
                ...
                >
                    ...
                    {post.featuredImage && (
                        <div className="mb-5 position-relative overflow-hidden border border-danger border-opacity-25">
                            <img src={post.featuredImage} alt={post.title} className="w-100 h-auto" style={{ filter: 'grayscale(0.2) contrast(1.1)', maxHeight: '600px', objectFit: 'cover' }} />
